...
export class NewFlashcardSet extends React.Component
{
    constructor(props)
    {
        super(props);
        ...
        fetch("process/newflashcardset",
            {
                ...
                body: `name=${encodeURIComponent(this.newName.value)}`
            })
            .then(res => res.json())
            .then(
                (result) => 
    ...
    render()
    {
        ...
        const dialog = !this.state.started && !this.state.finished ? (<div>
            <div className={styles["warning-title"]}>New Flashcard Set</div>
            <div className={styles["warning-message"]}>
                <p>Please specify a name for your new flashcard set:</p>
                <input type="text"
